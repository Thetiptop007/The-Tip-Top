  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="bg-gradient-to-r from-red-50 to-white px-6 py-4 -mx-6 -mt-6 mb-6 rounded-t-lg border-b border-red-100">
            <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
              🔐 Change Password
            </h2>
            <p className="text-sm text-gray-600 mt-1">Update your admin password for security</p>
          </div>
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
              ...
              <div className="relative">
                ...
                >
                  {showPassword.confirm ? (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                    </svg>
                  ) : (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            ...
            <button
              ...
              className={`w-full px-6 py-3 bg-gradient-to-r from-red-400 to-red-500 text-white font-semibold rounded-lg hover:from-red-500 hover:to-red-600 transition-all shadow-lg shadow-red-200 cursor-pointer ${
